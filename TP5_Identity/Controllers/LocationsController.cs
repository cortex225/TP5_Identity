...
namespace TP5_Identity.Controllers
{
    public class LocationsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Locations.Include(l => l.Voiture);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DateLocation,DureeEnJours,ClientId,VoitureId")] Location location)
        {
            if (id != location.Id)
            {
                return NotFound();
